...
U 1 1 55397DB3
P 5650 2100
F 0 "R5" H 5675 2125 30  0000 L CNN
F 1 "1M" H 5675 2075 30  0000 L CNN
...
Vout = 0.6V * (1 + R1/R2)
Text Notes 4350 2600 0    40   ~ 0
Requirement:\n- 100k <= R2 <= 600k\n- 1.8V <= Vout <= 3.6V\n\n-> 2*R2 <= R1 <= 5*R2\n
$Comp
L R R6
U 1 1 5539833E
P 5650 2300
F 0 "R6" H 5675 2325 30  0000 L CNN
F 1 "240k" H 5675 2275 30  0000 L CNN
...
U 1 1 553983F8
P 5650 2500
F 0 "R7" H 5675 2525 30  0000 L CNN
F 1 "240k" H 5675 2475 30  0000 L CNN
...
U 1 1 553984AB
P 5650 2600
F 0 "#PWR01" V 5770 2600 60  0001 C CNN
F 1 "PGND" H 5650 2510 30  0000 C CNN
...
U 1 1 55398E44
P 2300 1800
F 0 "D1" H 2325 1825 30  0000 L CNN
...
U 1 1 55398EC6
P 2300 1900
F 0 "D2" H 2325 1925 30  0000 L CNN
...
U 1 1 55398EFD
P 2150 1650
F 0 "R2" H 2175 1675 30  0000 L CNN
...
U 1 1 55398F35
P 2050 1650
F 0 "R1" H 2075 1675 30  0000 L CNN
...
U 1 1 553996EE
P 5450 2200
F 0 "C4" H 5475 2225 30  0000 L CNN
F 1 "18p" H 5475 2175 30  0000 L CNN
...
U 1 1 55399EFD
P 3500 2100
F 0 "R3" H 3525 2125 30  0000 L CNN
F 1 "10k" H 3525 2075 30  0000 L CNN
...
U 1 1 5539A0EE
P 3500 2300
F 0 "R4" H 3525 2325 30  0000 L CNN
...
F 1 "SENSE" H 5650 1450 30  0000 C CNN
...
Text Notes 5900 2450 0    40   ~ 0
With 1M+240k/240k:\n1.2V <= VREG <= 3.7V (typ)\n1.2V <= VREG <= 3.45V (worst, 10% tol on pot)
Wire Wire Line
	5050 1700 5250 1700
Wire Wire Line
	5250 1700 5250 2400
...
With 10k/1.2k:\n107mA <= Ibat <= 1A (typ)\n118mA <= Ibat <= 1A (worst, 10% tol on pot)\n
NoConn ~ 1450 3300
NoConn ~ 1650 3300
NoConn ~ 1850 3300
NoConn ~ 2050 3300
